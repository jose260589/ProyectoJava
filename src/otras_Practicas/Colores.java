...
import javax.swing.*; // para trabajar figuraas
import java.awt.*; 
import java.awt.event.*;//trabajar con eventos
...
public class Colores extends JFrame implements ActionListener{
 ...
 for(int i = 0; i<=255; i++){
     combo1.addItem(String.valueOf(i)); //es para comvertir el valor de i en String.
    }
 add(combo1);
 ...
 for(int i = 0; i<=255; i++){
     combo2.addItem(String.valueOf(i)); //es para comvertir el valor de i en String.
    }
 add(combo2);
 ...
 for(int i = 0; i<=255; i++){
     combo3.addItem(String.valueOf(i)); //es para comvertir el valor de i en String.
    }
 add(combo3);
 ...
 public static void main(String args[]){
  Colores formulario1 = new Colores();
